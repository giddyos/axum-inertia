//! Actix Web adapter for the framework-neutral Inertia runtime.
...
pub use app::{assets, configure};
pub use extract::{Inertia, Visit};
pub use form::{FormError, InertiaForm, Validated};
pub use middleware::{InertiaMiddleware, InertiaMiddlewareService};
pub use response::{ActixResponse, DynamicPage, Location, PendingPage, Redirect, Response, Result};
